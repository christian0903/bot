...
/**
 * Les cours, presentes comme sur la page « Nos cours semi-prives » du
 * WordPress : une grille de trois, chaque carte portant sa photo, son nom, une
 * pastille de couleur et son texte.
 *
 * Cette page existe EN PLUS de `/cours`, a la demande de Christian : les deux
 * presentations coexistent le temps que les coachs choisissent. Elles ne
 * partagent volontairement pas leurs donnees — la page `/cours` sert des textes
 * resserres et une fenetre de detail, celle-ci reprend les textes d'origine
 * dans leur longueur. Fusionner les deux avant la decision reviendrait a
 * trancher a la place des coachs.
 *
 * Une fois le choix fait, la page ecartee se supprime, et la survivante peut
 * reprendre le nom `/cours`.
 */
...
export function VitrineCours2Page() {
  return (
    <>

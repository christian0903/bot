...
// L'ancienne presentation des cours — liste resserree, fenetre de detail. Elle
// servait `/cours` jusqu'au 2026-08-31 ; Christian lui a prefere la grille du
// WordPress. Gardee sous `/cours-2` le temps de montrer les deux aux coachs,
// puis a supprimer.
const VitrineCoursListePage = lazy(() => import('@/pages/vitrine/VitrineCoursListePage').then(m => ({ default: m.VitrineCoursListePage })))
              ...
              <Routes>
                ...
                {MODE_VITRINE && (
                  <Route element={<Lazy><VitrineLayout /></Lazy>}>
                    ...
                    <Route path="/cours-2" element={<Lazy><VitrineCoursListePage /></Lazy>} />

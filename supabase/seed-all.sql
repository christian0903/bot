...
-- ============================================
-- 7. FRAIS D'INSCRIPTION (5 sur 6, Thomas non)
-- ============================================
...
-- ============================================
-- 10. RÉSERVATIONS (variées sur les cours de la semaine prochaine)
-- ============================================

-- Ingrid : 2 réservations (premier et deuxième cours dispo)
...
INSERT INTO bookings (scheduled_class_id, user_id, pack_purchase_id)
SELECT sc.id, 'aaaa0001-0001-0001-0001-000000000002', 'bbbb0001-0001-0001-0001-000000000002'
FROM scheduled_classes sc WHERE sc.starts_at > NOW() ORDER BY sc.starts_at OFFSET 5 LIMIT 1;
...
-- Anouck : 2 réservations semi-privé
INSERT INTO bookings (scheduled_class_id, user_id, pack_purchase_id)
...
INSERT INTO bookings (scheduled_class_id, user_id, pack_purchase_id)
SELECT sc.id, 'aaaa0001-0001-0001-0001-000000000004', 'bbbb0001-0001-0001-0001-000000000004'
FROM scheduled_classes sc WHERE sc.starts_at > NOW() ORDER BY sc.starts_at OFFSET 7 LIMIT 1;

-- Déduire les crédits
UPDATE pack_purchases SET credits_remaining = credits_remaining - 2 WHERE id = 'bbbb0001-0001-0001-0001-000000000001'; -- Ingrid: 7→5
UPDATE pack_purchases SET credits_remaining = credits_remaining - 3 WHERE id = 'bbbb0001-0001-0001-0001-000000000002'; -- Sophie: 18→15
...
-- Anouck a parrainé Lucas (en attente — Lucas n'a pas encore 10 séances)
